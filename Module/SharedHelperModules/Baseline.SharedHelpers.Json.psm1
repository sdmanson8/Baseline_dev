<#
    .SYNOPSIS
    Named module boundary for Json.Helpers.ps1 — exposes its functions through the module system.
...
$helperPath = Join-Path -Path (Join-Path $Script:SharedHelpersModuleRoot 'SharedHelpers') -ChildPath 'Json.Helpers.ps1'

<#
    .SYNOPSIS
    Module wrapper for WindowPosition.Helpers.ps1.
...
$helperPath = Join-Path -Path (Join-Path $Script:SharedHelpersModuleRoot 'SharedHelpers') -ChildPath 'WindowPosition.Helpers.ps1'

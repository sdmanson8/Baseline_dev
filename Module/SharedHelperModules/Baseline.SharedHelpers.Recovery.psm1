<#
    .SYNOPSIS
    Named module boundary for Recovery.Helpers.ps1 — exposes its functions through the module system.
...
$helperPath = Join-Path -Path (Join-Path $Script:SharedHelpersModuleRoot 'SharedHelpers') -ChildPath 'Recovery.Helpers.ps1'

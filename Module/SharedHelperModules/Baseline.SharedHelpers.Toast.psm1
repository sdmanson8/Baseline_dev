<#
    .SYNOPSIS
    Module wrapper for Toast.Helpers.ps1.
...
$helperPath = Join-Path -Path (Join-Path $Script:SharedHelpersModuleRoot 'SharedHelpers') -ChildPath 'Toast.Helpers.ps1'
...
$ExportedFunctions = @(
    'New-BaselineToastXml'
    'Test-BaselineToastRuntimeAvailable'
    'Send-BaselineToastXml'
    'Show-BaselineToast'
    'Register-BaselineToastApp'
    'Unregister-BaselineToastApp'
)

...
$bc = New-SafeBrushConverter -Context 'DialogHelpers-Settings'
	...
	$settingsStartupSplashSection = Get-UxLocalizedString -Key 'GuiSettingsStartupSplashSection' -Fallback 'Startup splash checks'
	$settingsStartupSplashSubtitle = Get-UxLocalizedString -Key 'GuiSettingsStartupSplashSubtitle' -Fallback 'Choose which startup work Baseline performs before the main window opens. Changes apply on the next launch.'
	$settingsStartupRunInitialActionsLabel = Get-UxLocalizedString -Key 'GuiSettingsStartupRunInitialActionsLabel' -Fallback 'Run initial startup checks during splash'
	$settingsStartupCheckWinGetLabel = Get-UxLocalizedString -Key 'GuiSettingsStartupCheckWinGetLabel' -Fallback 'Check WinGet during splash'
	$settingsStartupWinGetCheckFrequencyLabel = Get-UxLocalizedString -Key 'GuiSettingsStartupWinGetCheckFrequencyLabel' -Fallback 'WinGet check frequency'
	$settingsStartupCheckChocolateyLabel = Get-UxLocalizedString -Key 'GuiSettingsStartupCheckChocolateyLabel' -Fallback 'Check Chocolatey during splash'
	$settingsStartupChocolateyCheckFrequencyLabel = Get-UxLocalizedString -Key 'GuiSettingsStartupChocolateyCheckFrequencyLabel' -Fallback 'Chocolatey check frequency'
	$settingsStartupSplashHelper = Get-UxLocalizedString -Key 'GuiSettingsStartupSplashHelper' -Fallback 'Initial actions, WinGet, and Chocolatey checks are controlled independently. Package-manager frequency is evaluated at launch.'

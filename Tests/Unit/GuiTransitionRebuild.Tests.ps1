...
Describe 'Focused GUI rebuilds' {
    ...
    It 'routes menu-state sync fallbacks through Write-DebugSwallowedException' {
        ...
        $script:ActionHandlersContent | Should -Match 'ActionHandlers\.SyncMenuState\.MenuViewSafeMode\.SetChecked'
        $script:ActionHandlersContent | Should -Match 'ActionHandlers\.SyncMenuState\.MenuViewSafeMode\.SyncClick'
        $script:ActionHandlersContent | Should -Match 'ActionHandlers\.SyncMenuState\.MenuViewSafeMode\.Checked'
        $script:ActionHandlersContent | Should -Match 'ActionHandlers\.SyncMenuState\.MenuViewSafeMode\.Unchecked'

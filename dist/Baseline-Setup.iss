...
begin
  ...
  LocaleEntries[11]  := 'Cherokee|ᏣᎳᎩ|chr';
  LocaleEntries[12]  := 'Central Kurdish|کوردیی ناوەندی|ckb';
  LocaleEntries[13]  := 'Czech|čeština|cs';
  LocaleEntries[14]  := 'Welsh|Cymraeg|cy';
  LocaleEntries[15]  := 'Danish|dansk|da';
  LocaleEntries[16]  := 'German|Deutsch|de';
  LocaleEntries[17]  := 'Greek|Ελληνικά|el';
  LocaleEntries[18]  := 'English (US)|English|en';
  LocaleEntries[19]  := 'English (United Kingdom)|English (United Kingdom)|en-GB';
  LocaleEntries[20]  := 'English (Australia)|English (Australia)|en-AU';
  LocaleEntries[21]  := 'English (Belize)|English (Belize)|en-BZ';
  LocaleEntries[22]  := 'English (Canada)|English (Canada)|en-CA';
  LocaleEntries[23]  := 'English (Caribbean)|English (Caribbean)|en-029';
  LocaleEntries[24]  := 'English (India)|English (India)|en-IN';
  LocaleEntries[25]  := 'English (Ireland)|English (Ireland)|en-IE';
  LocaleEntries[26]  := 'English (Jamaica)|English (Jamaica)|en-JM';
  LocaleEntries[27]  := 'English (Malaysia)|English (Malaysia)|en-MY';
  LocaleEntries[28]  := 'English (Maldives)|English (Maldives)|en-MV';
  LocaleEntries[29]  := 'English (New Zealand)|English (New Zealand)|en-NZ';
  LocaleEntries[30]  := 'English (Philippines)|English (Philippines)|en-PH';
  LocaleEntries[31]  := 'English (Singapore)|English (Singapore)|en-SG';
  LocaleEntries[32]  := 'English (South Africa)|English (South Africa)|en-ZA';
  LocaleEntries[33]  := 'English (Trinidad and Tobago)|English (Trinidad and Tobago)|en-TT';
  LocaleEntries[34]  := 'English (United Arab Emirates)|English (United Arab Emirates)|en-AE';
  LocaleEntries[35]  := 'English (Zimbabwe)|English (Zimbabwe)|en-ZW';
  LocaleEntries[36]  := 'Spanish|español|es';
  LocaleEntries[37]  := 'Spanish (Mexico)|español (México)|es-MX';
  LocaleEntries[38]  := 'Estonian|eesti|et';
  LocaleEntries[39]  := 'Basque|euskara|eu';
  LocaleEntries[40]  := 'Persian|فارسی|fa';
  LocaleEntries[41]  := 'Finnish|suomi|fi';
  LocaleEntries[42]  := 'Filipino|Filipino|fil';
  LocaleEntries[43]  := 'French|français|fr';
  LocaleEntries[44]  := 'French (Canada)|français (Canada)|fr-CA';
  LocaleEntries[45]  := 'Irish|Gaeilge|ga';
  LocaleEntries[46]  := 'Scottish Gaelic|Gàidhlig|gd';
  LocaleEntries[47]  := 'Galician|galego|gl';
  LocaleEntries[48]  := 'Gujarati|ગુજરાતી|gu';
  LocaleEntries[49]  := 'Hausa|Hausa|ha';
  LocaleEntries[50]  := 'Hebrew|עברית|he';
  LocaleEntries[51]  := 'Hindi|हिन्दी|hi';
  LocaleEntries[52]  := 'Croatian|hrvatski|hr';
  LocaleEntries[53]  := 'Hungarian|magyar|hu';
  LocaleEntries[54]  := 'Armenian|հայերեն|hy';
  LocaleEntries[55]  := 'Indonesian|Indonesia|id';
  LocaleEntries[56]  := 'Igbo|Igbo|ig';
  LocaleEntries[57]  := 'Icelandic|íslenska|is';
  LocaleEntries[58]  := 'Italian|italiano|it';
  LocaleEntries[59]  := 'Japanese|日本語|ja';
  LocaleEntries[60]  := 'Georgian|ქართული|ka';
  LocaleEntries[61]  := 'Kazakh|қазақ тілі|kk';
  LocaleEntries[62]  := 'Khmer|ខ្មែរ|km';
  LocaleEntries[63]  := 'Kannada|ಕನ್ನಡ|kn';
  LocaleEntries[64]  := 'Korean|한국어|ko';
  LocaleEntries[65]  := 'Konkani|कोंकणी|kok';
  LocaleEntries[66]  := 'Kyrgyz|кыргызча|ky';
  LocaleEntries[67]  := 'Luxembourgish|Lëtzebuergesch|lb';
  LocaleEntries[68]  := 'Lao|ລາວ|lo';
  LocaleEntries[69]  := 'Lithuanian|lietuvių|lt';
  LocaleEntries[70]  := 'Latvian|latviešu|lv';
  LocaleEntries[71]  := 'Maori|Māori|mi';
  LocaleEntries[72]  := 'Macedonian|македонски|mk';
  LocaleEntries[73]  := 'Malayalam|മലയാളം|ml';
  LocaleEntries[74]  := 'Mongolian|монгол|mn';
  LocaleEntries[75]  := 'Marathi|मराठी|mr';
  LocaleEntries[76]  := 'Malay|Melayu|ms';
  LocaleEntries[77]  := 'Maltese|Malti|mt';
  LocaleEntries[78]  := 'Norwegian Bokmal|norsk bokmål|nb';
  LocaleEntries[79]  := 'Nepali|नेपाली|ne';
  LocaleEntries[80]  := 'Dutch|Nederlands|nl';
  LocaleEntries[81]  := 'Dutch (Belgium)|Nederlands (België)|nl-BE';
  LocaleEntries[82]  := 'Norwegian Nynorsk|norsk nynorsk|nn';
  LocaleEntries[83]  := 'Sesotho sa Leboa|Sesotho sa Leboa|nso';
  LocaleEntries[84]  := 'Odia|ଓଡ଼ିଆ|or';
  LocaleEntries[85]  := 'Punjabi|ਪੰਜਾਬੀ|pa';
  LocaleEntries[86]  := 'Punjabi (Arabic)|پنجابی (عربی)|pa-Arab';
  LocaleEntries[87]  := 'Polish|polski|pl';
  LocaleEntries[88]  := 'Dari|دری|prs';
  LocaleEntries[89]  := 'Pashto|پښتو|ps';
  LocaleEntries[90]  := 'Portuguese|português|pt';
  LocaleEntries[91]  := 'Portuguese (Brazil)|português (Brasil)|pt-BR';
  LocaleEntries[92]  := 'Quechua|Runasimi|qu';
  LocaleEntries[93]  := 'Kiche|Kʼicheʼ|quc';
  LocaleEntries[94]  := 'Romanian|română|ro';
  LocaleEntries[95]  := 'Russian|русский|ru';
  LocaleEntries[96]  := 'Kinyarwanda|Kinyarwanda|rw';
  LocaleEntries[97]  := 'Sindhi|سنڌي|sd';
  LocaleEntries[98]  := 'Sinhala|සිංහල|si';
  LocaleEntries[99]  := 'Slovak|slovenčina|sk';
  LocaleEntries[100]  := 'Slovenian|slovenščina|sl';
  LocaleEntries[101]  := 'Albanian|shqip|sq';
  LocaleEntries[102]  := 'Serbian|српски|sr';
  LocaleEntries[103]  := 'Serbian (Cyrillic)|српски (ћирилица)|sr-Cyrl';
  LocaleEntries[104]  := 'Swedish|svenska|sv';
  LocaleEntries[105]  := 'Swahili|Kiswahili|sw';
  LocaleEntries[106]  := 'Tamil|தமிழ்|ta';
  LocaleEntries[107]  := 'Telugu|తెలుగు|te';
  LocaleEntries[108]  := 'Thai|ไทย|th';
  LocaleEntries[109]  := 'Tigrinya|ትግርኛ|ti';
  LocaleEntries[110]  := 'Turkmen|türkmen dili|tk';
  LocaleEntries[111]  := 'Setswana|Setswana|tn';
  LocaleEntries[112]  := 'Turkish|Türkçe|tr';
  LocaleEntries[113]  := 'Tatar|татар|tt';
  LocaleEntries[114]  := 'Uyghur|ئۇيغۇرچە|ug';
  LocaleEntries[115]  := 'Ukrainian|українська|uk';
  LocaleEntries[116]  := 'Urdu|اردو|ur';
  LocaleEntries[117]  := 'Uzbek|o''zbek|uz';
  LocaleEntries[118]  := 'Vietnamese|Tiếng Việt|vi';
  LocaleEntries[119]  := 'Wolof|Wolof|wo';
  LocaleEntries[120]  := 'Xhosa|IsiXhosa|xh';
  LocaleEntries[121]  := 'Yoruba|Èdè Yorùbá|yo';
  LocaleEntries[122]  := 'Chinese (Simplified)|中文（简体）|zh-Hans';
  LocaleEntries[123]  := 'Chinese (Traditional)|中文（繁體）|zh-Hant';
  LocaleEntries[124]  := 'Zulu|isiZulu|zu';
end;
